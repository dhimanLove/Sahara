  ...
  head: () => ({
    meta: [
      { title: "Impact - Sahara" },
      {
        name: "description",
        content:
          "The numbers behind our mission to protect 300M widows in South Asia.",
      },
    ],
  }),
  component: Impact,
    ...
    <div className="relative">
      <svg viewBox="0 0 500 500" className="w-full">
        ...
        <circle
          ...
          strokeWidth="1.5"
        />
        <text x="100" y="125" fontSize="9" fill="#333" fontWeight="500">
          Islamabad
        </text>
        ...
        <circle
          ...
          strokeWidth="1.5"
        />
        <text x="250" y="210" fontSize="9" fill="#333" fontWeight="600">
          New Delhi
        </text>
        ...
        <circle
          ...
          strokeWidth="1.5"
        />
        <text x="275" y="155" fontSize="9" fill="#333" fontWeight="500">
          Kathmandu
        </text>
        ...
        <circle
          ...
          strokeWidth="1.5"
        />
        <text x="390" y="240" fontSize="9" fill="#333" fontWeight="500">
          Dhaka
        </text>
        ...
        <circle
          ...
          strokeWidth="1.5"
        />
        <text x="285" y="435" fontSize="9" fill="#333" fontWeight="500">
          Colombo
        </text>
      </svg>
    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Expected reach across South Asia
          </p>
        </div>
      ...
      <div className="relative">
        <svg viewBox="0 0 400 280" className="w-full">
          ...
          {/* Y-axis labels */}
          <text x="45" y="244" fontSize="8" fill="#9CA3AF" textAnchor="end">
            0
          </text>
          <text x="45" y="184" fontSize="8" fill="#9CA3AF" textAnchor="end">
            1.25M
          </text>
          <text x="45" y="124" fontSize="8" fill="#9CA3AF" textAnchor="end">
            2.5M
          </text>
          <text x="45" y="64" fontSize="8" fill="#9CA3AF" textAnchor="end">
            5M
          </text>
...
const SDGS = [
  {
    ...
    title: "No Poverty",
    color: "#E63946",
    how: "Protecting widows' assets keeps families above poverty line",
  },
  {
    n: 5,
    title: "Gender Equality",
    color: "#F4A261",
    how: "Equal legal access for the most marginalised women",
  },
  {
    n: 10,
    title: "Reduced Inequalities",
    color: "#2A9D8F",
    how: "Bridging the legal knowledge gap between rural and urban",
  },
  {
    n: 16,
    title: "Peace & Justice",
    color: "#264653",
    how: "Making justice institutions accessible to the last mile",
  },
];

const TESTIMONIALS = [
  {
    quote: "For the first time, I understood what the law said about my land.",
    name: "Meera Devi",
    location: "Bihar, India",
  },
  {
    quote: "Sahara helped us draft a letter to the tehsildar the same day.",
    name: "Anita Begum",
    location: "Khulna, Bangladesh",
  },
  {
    quote:
      "I was told I had no rights. Sahara told me exactly which law protected me.",
    name: "Kamala Tamang",
...
function Impact() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(sdgsRef.current?.children || [], {
        opacity: 0,
        y: 30,
        stagger: 0.1,
        duration: 0.6,
        scrollTrigger: { trigger: sdgsRef.current, start: "top 85%" },
      });
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageMeta
        title="Impact - Sahara"
        desc="The numbers behind our mission."
      />
      ...
      <div ref={heroRef} className="border-b border-border">
        <div className="mx-auto max-w-6xl px-6 py-16 text-center sm:px-8 lg:py-20">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-muted-foreground">
            300 million widows. 7 countries. One mission.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {SDGS.map((sdg) => (
            ...
            >
              <div className="text-2xl font-light" style={{ color: sdg.color }}>
                {sdg.n}
              </div>
              ...
              <div key={i} className="border border-border bg-background p-5">
                <div className="flex gap-0.5">
                  {[...Array(5)].map((_, k) => (
                    <Star
                      key={k}
                      className="h-3 w-3 fill-primary/20 text-primary/20"
                    />
                  ))}
                </div>
      ...
      <div className="mx-auto max-w-6xl px-6 py-12 text-center sm:px-8">
        <div className="inline-flex items-center gap-2 rounded-sm border border-primary/20 bg-primary/5 px-4 py-2">
          ...
          <span className="text-xs font-medium text-primary">
            Building measurable impact · Aligned with UN SDGs
          </span>
        </div>
      </div>
    </div>
